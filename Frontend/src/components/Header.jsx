    ...
    <header style={{
      ...
      <div style={{
        ...
        >
          {/* 3 lines icon */}
          <div>
            <div style={{ width: "18px", height: "2px", backgroundColor: "white", marginBottom: "4px" }} />
            <div style={{ width: "18px", height: "2px", backgroundColor: "white", marginBottom: "4px" }} />
            <div style={{ width: "18px", height: "2px", backgroundColor: "white" }} />
          </div>
        </button>
      ...
      <div style={{
        ...
        {user ? (
              ...
              {showDropdown && (
                <>
                  ...
                  <div style={{
                    ...
                    {/* Menu items */}
                    {[
                      { icon: "👤", label: "Your channel", action: () => { navigate("/channel/mine"); setShowDropdown(false); } },
                      { icon: "➕", label: "Create channel", action: () => { navigate("/create-channel"); setShowDropdown(false); } },
                      { icon: "⬆️", label: "Upload video", action: () => { navigate("/upload"); setShowDropdown(false); } },
                    ].map((item) => (
                      <div
                        key={item.label}
                        onClick={item.action}
          ...
          <button
            ...
            onMouseLeave={(e) => e.currentTarget.style.backgroundColor = "transparent"}
          >
            <svg viewBox="0 0 24 24" style={{ width: "20px", height: "20px", fill: "#3ea6ff" }}>
